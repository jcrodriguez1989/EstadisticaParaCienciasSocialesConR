...
Cuando la variable admite números decimales se la llama **continua**, y allí el problema es mayor, porque el número de valores puede ser muy elevado y la única opción es la de construir categorías.
