...
Una línea de tiempo sobre el desarrollo de R puede encoontrar en https://blog.revolutionanalytics.com/2017/10/updated-history-of-r.html  
...
x<-seq(1,10,.1)
y<-3-2*x+rnorm(91)
plot(x,y, xlab = "valor de x", ylab = "valor de y",
