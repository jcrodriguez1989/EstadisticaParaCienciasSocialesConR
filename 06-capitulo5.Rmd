...
kableExtra::kable_styling(
  knitr::kable(aux_table, format = "pandoc", booktabs = TRUE, align = "llcl"),
  latex_options = "striped")
```
...
kableExtra::kable_styling(
  knitr::kable(cor.conf, format = "pandoc", booktabs = TRUE, align = "ccccccc"),
  latex_options = "striped")
```
...
disposición semejante a una recta (creciente, como en el gráfico <!--referencia al 3--> o
decreciente, como en el <!--referencia al 5-->), podremos buscar la función lineal que mejor
...
negativa) como en los gráficos <!--referencia a 7 y 8--> todos los puntos estarían sobre la
...
como la del gráfico <!--referenia al 6-->, el coeficiente de Pearson dará un valor muy bajo,
