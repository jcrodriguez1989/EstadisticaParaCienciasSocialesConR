...
kableExtra::kable_styling(
  knitr::kable(aux_table, format = "markdown", booktabs = TRUE, align = "llcl"),bootstrap_options = c("striped", "hover")
  )
```
