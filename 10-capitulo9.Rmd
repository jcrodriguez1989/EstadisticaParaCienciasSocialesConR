...
ggplot(muestra_tercer_parcial)+geom_histogram(aes(x=Media,
    y =..density..), fill="green")+stat_function(
      fun = dnorm, args = list(mean = mean(muestra_tercer_parcial$Media),
...
```{r echo=TRUE, warning=FALSE}
ggplot(muestra_tercer_parcial)+geom_histogram(aes(x=Varianza,
    y =..density..), fill="green")+
  theme_tufte()
```
