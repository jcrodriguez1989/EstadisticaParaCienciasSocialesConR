...
```{r}
tres_parciales_2009 <- read.table("bases/archivostxt/tres.parciales.2009.txt", header = TRUE, sep = ";")
tres_parciales_2009$Tercero <- as.numeric(as.character(tres_parciales_2009$Tercero))
...
```{r}
ggplot(tres_parciales_2009) + geom_histogram(aes(Tercero), fill = "green", bins = 10, col = "black") + xlab("notas del tercer parcial 2009") + ylab("frecuencia") + theme_tufte()
```
...
knitr::include_graphics("imagenes/image153.png")
```
...
```{r}
ggplot(data = data.frame(z = c(0, 100)), aes(z)) +
