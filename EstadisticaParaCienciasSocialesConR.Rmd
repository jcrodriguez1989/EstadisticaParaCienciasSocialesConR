...
kableExtra::kable_styling(
  knitr::kable(preferencia, format = "pandoc", booktabs = TRUE, align = "lr",
...
kableExtra::kable_styling(
  knitr::kable(aux, format = "pandoc", booktabs = TRUE, align = "lr",
               caption = "Área de trabajo preferida."),
  latex_options = "striped")
```
...
<!-- No logro centrar este texto, -> <- no anda-->
<!-- JCR: Asi esta bien? -->
...
kableExtra::kable_styling(
  knitr::kable(aux_table, format = "pandoc", booktabs = TRUE, align = "cl",
...
kableExtra::kable_styling(
  knitr::kable(aux_table, format = "pandoc", booktabs = TRUE, align = "clcl",
               label = "nivelNomCod",
...
<!-- PROBLEMA CON LAS REFERENCIAS, ESAS TABLAS ESTÁN HECHAS A MANO, ¿SE PODRÁN REFERENCIAR? -->
<!-- JCR: Creo que eso es lo que querias. -->
...
kableExtra::kable_styling(
  knitr::kable(aux_table, format = "pandoc", booktabs = TRUE, align = "l",
...
kableExtra::kable_styling(
  knitr::kable(aux_table, format = "pandoc", booktabs = TRUE, align = "ll",
...
kableExtra::kable_styling(
  knitr::kable(aux_table, format = "pandoc", booktabs = TRUE, align = "c",
...
kableExtra::kable_styling(
  knitr::kable(aux_table, format = "markdown", booktabs = TRUE, align = "llll",
               escape = FALSE),
...
kableExtra::kable_styling(
  knitr::kable(censo2010, format = "pandoc", booktabs = TRUE, align = "lcc",
               escape = FALSE),
  latex_options = "striped", full_width = FALSE)
```
...
kableExtra::kable_styling(
  knitr::kable(tabla8, format = "pandoc", booktabs = TRUE, align = "lc", 
...
kableExtra::kable_styling(
  knitr::kable(tabla11, format = "pandoc", booktabs = TRUE, align = "ccc",
               label = "abs",
...
tabla12 <- tabla12 * 100
kableExtra::kable_styling(
  knitr::kable(tabla12, format = "pandoc", booktabs = TRUE, align = "ccc",
               label = "rel",
...
kableExtra::kable_styling(
  knitr::kable(tabla13, format = "pandoc", booktabs = TRUE, align = "ccc",
               label = "frecConj",
...
tabla14 <- tabla14[-2, ]
kableExtra::kable_styling(
  knitr::kable(tabla14, format = "pandoc", booktabs = TRUE, align = "ccc",
...
kableExtra::kable_styling(
  knitr::kable(tabla17, format = "pandoc", booktabs = TRUE, align = "ccc",
               label = "tablaanterior",
...
kableExtra::kable_styling(
  knitr::kable(tabla18, format = "pandoc", booktabs = TRUE, align = "ccc",
...
kableExtra::kable_styling(
  knitr::kable(tabla19, format = "pandoc", booktabs = TRUE, align = "ccc",
               caption = "Frecuencias relativas por columnas esperadas bajo la hipótesis de independencia correspondiente a la tabla anterior"),
  latex_options = "striped")
```
...
kableExtra::kable_styling(
  knitr::kable(tabla20, format = "pandoc", booktabs = TRUE, align = "ccccc",
...
p1 <- ggplot(fuerte) +
  ...
  annotate(geom = "text", label = "relación directa, fuerte", col = "red",
...
p2 <- ggplot(fuerte) +
  ...
  annotate(geom = "text", label = "relación directa, débil", col = "red",
...
<!-- caption: Ilustración del procedimiento de muestreo sistemático-->
<!-- todo: poner este caption -->
...
knitr::kable(aux_table, kable_outp, align = "c", booktabs = TRUE) %>%
  kableExtra::footnote(general_title = "Fuente: ", footnote_as_chunk = TRUE,
...
```{r}
enfr <- read.table(
  "bases/archivostxt/ENFR2013_baseusuario.txt", sep = "|", header = TRUE)
...
knitr::kable(
  aux_table, kable_outp, booktabs = TRUE, align = "lccccccc", caption =
...
knitr::kable(
  aux_table, kable_outp, booktabs = TRUE, align = "lccccccc") %>%
  kableExtra::kable_styling(latex_options = "striped") %>%
  kableExtra::add_header_above(c(" " = 2, "Primer dado" = 6)) %>%
  kableExtra::collapse_rows(columns = 1:2, valign = "top")
```
...
knitr::kable(
  aux_table, kable_outp, booktabs = TRUE, align = "lcc", caption =
...
kableExtra::kable_styling(
  knitr::kable(
    aux_table, kable_outp, booktabs = TRUE, align = "lcccc", caption =
...
knitr::kable(
  aux_table, kable_outp, booktabs = TRUE, align = "lccccc", caption =
...
knitr::kable(
  aux_table, kable_outp, booktabs = TRUE, align = "lccc") %>%
  kableExtra::kable_styling(latex_options = "striped") %>%
...
knitr::kable(
  aux_table, kable_outp, booktabs = TRUE, align = "cc") %>%
  kableExtra::kable_styling(latex_options = "striped")
```
...
ggplot(moneda,aes(lado, probs))+geom_bar(stat = "identity", fill="green")+
  theme_tufte()+xlab("lado de la moneda")+ylab("probabilidades")

cara_dado=c(1:6)
probs=rep(1/6, 6)
dado=data.frame(cara_dado,probs)
ggplot(dado,aes(cara_dado, probs))+geom_bar(stat = "identity", fill="green")+
  theme_tufte()+xlab("número del dado")+ylab("probabilidades")

cara_icos=c(1:20)
probs=rep(1/20,20)
icos=data.frame(cara_icos,probs)
ggplot(icos,aes(cara_icos, probs))+geom_bar(stat = "identity", fill="green")+
  theme_tufte()+xlab("cara del icosaedro")+ylab("probabilidades")
...
knitr::kable(
  aux_table, kable_outp, booktabs = TRUE, align = "lc") %>%
  kableExtra::kable_styling(latex_options = "striped")
```
...
ggplot(NULL, aes(c(-4,4))) +
  geom_area(stat = "function", fun = dnorm, col="black", fill = "green", xlim = c(-4, 0)) +
  geom_area(stat = "function", fun = dnorm, col="black",fill = "white", xlim = c(0, 4))+ylab("") + xlab("z")+
  scale_y_continuous(breaks = NULL)+theme_tufte()
```
...
```{r}
ggplot(NULL, aes(c(-4,4))) +
  geom_area(stat = "function", fun = dnorm, col="black", fill = "green", xlim = c(-4, 2)) +
  geom_area(stat = "function", fun = dnorm, col="black",fill = "white", xlim = c(2, 4))+ylab("") + xlab("z")+
  scale_y_continuous(breaks = NULL)+theme_tufte()
```
...
ggplot(NULL, aes(c(-4,4))) +
  geom_area(stat = "function", fun = dnorm, col="black", fill = "green", xlim = c(-4, -2)) +
  geom_area(stat = "function", fun = dnorm, col="black",fill = "white", xlim = c(-2, 4))+ylab("") + xlab("z")+geom_segment(aes(x=-3, xend=-2.2, y=.09,yend=.02), arrow = arrow())+annotate(geom = "text", label="P(z<-2) = 0.0227", x=-3, y=.1)+
  scale_y_continuous(breaks = NULL)+theme_tufte()

ggplot(NULL, aes(c(-4,4))) +
  geom_area(stat = "function", fun = dnorm, col="black", fill = "green", xlim = c(-4, 1)) +
  geom_area(stat = "function", fun = dnorm, col="black",fill = "white", xlim = c(1, 4))+ylab("") + xlab("z")+geom_segment(aes(x=-3, xend=-2, y=.23, yend=.15), arrow = arrow())+annotate(geom = "text", label="P(z<1) = 0.8413", x=-3, y=.25)+
  scale_y_continuous(breaks = NULL)+theme_tufte()
```
...
knitr::kable(
  aux_table, kable_outp, booktabs = TRUE, align = "lcccc") %>%
  kableExtra::kable_styling(latex_options = "striped")
```
...
```{r}
ggplot(NULL, aes(c(0,30))) +
  geom_area(stat = "function", fun = dchisq, args= list(df=13), col="black", fill = "white", xlim = c(0, qchisq(.05, 13))) +
  geom_area(stat = "function", fun = dchisq, args= list(df=13), col="black",fill = "green", xlim = c(qchisq(.05,13),qchisq(.95,13)))+
  geom_area(stat = "function", fun = dchisq, args= list(df=13), col="black",fill = "white", xlim = c(qchisq(.95,13),30))+ylab("") + xlab("")+
  scale_y_continuous(breaks = NULL)+theme_tufte()
```
