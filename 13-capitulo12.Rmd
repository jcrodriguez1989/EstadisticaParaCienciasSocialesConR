...
<!-- resumen_hijos <- summaryBy(hijos ~ grupo_edad, data = subset(adultos_mayores, is.na(adultos_mayores$hijos) == FALSE & is.na(adultos_mayores$grupo_edad) == FALSE), FUN = c(length, mean, median, sd)) -->
<!-- kable(resumen_hijos) -->
<!-- ``` -->
