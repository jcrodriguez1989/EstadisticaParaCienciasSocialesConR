...
avanzaremos en ese tema pero de manera muy simple, podemos pensar en dos grupos de personas depresivas a uno de los cuales se administra la
...
grupos. Los del segundo grupo (66 o más) tienen en promedio 0.12 hijes
...
Por cuestiones de economía de recursos, los software usan siempre distribución t. La salida muestra: la variable que se analiza (hijes), según la que clasifica los grupos (grupo_edad), el valor del estadístico de prueba (t=-0.94), los grados de libertad (495), el valor de probabilidad asociado a la
...
*p* es, en este caso "si el número promedio de hijos e hijas de los dos grupos
...
Y se solicita la prueba de hijes según grupos de edad, unilateral izquierda:
