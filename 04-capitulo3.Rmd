...
Los cuantiles usan las frecuencias relativas acumuladas, por eso solo existen para variables de nivel superior al nominal.  Veamos la presentación por medio de un ejemplo, con la tabla siguiente que tiene calculadas las frecuencias acumuladas y se muestran solo ellas:
...
partes o el 75% del total de observaciones. |
...
Los cortes que generan 10 grupos con la misma cantidad de casos se llaman **deciles**. Por ejemplo, el segundo decil se escribe $D_2$ es el valor de la variables que deja por debajo al 20% de los casos, por lo que coincide con el primer quintil y el percentil 20.    

La mediana, los cuartiles, quintiles, deciles y percentiles son todos casos particulares de un conjunto de medidas general: los cuantiles. La mediana es el cuantil 0.50, define dos grupos con la mitad de los casos en cada uno; los cuartiles definen cuatro, los quintiles cinco (con 20% en cada uno), los deciles diez y los cuantiles cortan el campo de variación de la variable en 100 grupos, cada uno de los cuales tiene al 1% del total de casos.  
